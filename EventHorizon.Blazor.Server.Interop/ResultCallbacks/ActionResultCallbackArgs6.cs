...
public class ActionResultCallback<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>
{
    ...
    private Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, ValueTask<TResult>> _callback;
    ...
    public ActionResultCallback(
        Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, ValueTask<TResult>> callback
    )
    {
        _callback = callback;
    ...
    [JSInvokable]
    public ValueTask<TResult> HandleCallback(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, TArg6 arg6)
    {
