...
public class ActionResultCallback<TArg1, TArg2, TResult>
{
    ...
    private readonly Func<TArg1, TArg2, ValueTask<TResult>> _callback;
    ...
    public ActionResultCallback(
        Func<TArg1, TArg2, ValueTask<TResult>> callback
    )
    {
        _callback = callback;
    ...
    [JSInvokable]
    public ValueTask<TResult> HandleCallback(TArg1 arg1, TArg2 arg2)
    {
